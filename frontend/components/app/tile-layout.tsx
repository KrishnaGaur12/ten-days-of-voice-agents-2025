...
const ECGVisualizer = ({
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      ctx.shadowBlur = 8;
      ctx.shadowColor = '#f472b6'; // Pink-400 Glow
              ...
              {!isAvatar && (
                ...
                <MotionContainer
                  ...
                  className={cn(
                    ...
                    // Game Show Style: Deep Purple bg, Gold border
                    'bg-purple-950/80 backdrop-blur-md',
                    'border-2 border-yellow-400/60',
                    'shadow-[0_0_30px_-5px_rgba(250,204,21,0.3)]', // Gold glow
                    chatOpen ? 'h-[60px] w-[60px] rounded-lg' : 'h-[120px] w-[120px] rounded-2xl'
                  )}
                >
              ...
              {isAvatar && (
                ...
                <MotionContainer
                  ...
                  className={cn(
                    ...
                    'border-2 border-pink-500/50 shadow-[0_0_30px_-5px_rgba(236,72,153,0.3)]',
                    chatOpen 
                      ? 'h-[60px] w-[60px]' 
              ...
              {(cameraTrack && isCameraEnabled || screenShareTrack && isScreenShareEnabled) && (
                <MotionContainer
                  ...
                  className={cn(
                    ...
                    'border-2 border-cyan-400/50 bg-neutral-900',
                ...
                >
                  ...
                  />
                  {/* Status Indicator */}
                  <div className="absolute bottom-1 right-1 h-2 w-2 rounded-full bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,1)]" />
                </MotionContainer>
              )}
            </AnimatePresence>
          </div>
